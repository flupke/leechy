...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Leecher.settings'
        db.add_column('leechy_leecher', 'settings', self.gf('leechy.fields.JSONField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Leecher.settings'
        db.delete_column('leechy_leecher', 'settings')
